...
const ModalWindowCategoryList = memo((props: {
  ...
  return <Modal animationType="slide" transparent={false} visible={props.visible} onRequestClose={() => props.setVisible(false)}>
      ...
      Keyboard.dismiss();
            ...
            borderColor: '#C6C3C3'
              ...
              color: '#C6C3C3'
            }}>{props.buttonTextLeft}</ButtonTypeText>
                        </ButtonType>
            ...
            }}>{props.buttonTextRight}</ButtonTypeText>
                        </ButtonType>
                    </ButtonTypeView>
                    <InputView>
                        {props.children}
